...
NAME
----
shadowsocks-c - a lightweight and secure socks5 proxy
...
*shadowsocks-c* is written in pure C and takes advantage of *libev*
...
Set the cipher.
+
*shadowsocks-c* accepts 22 different ciphers:
+
