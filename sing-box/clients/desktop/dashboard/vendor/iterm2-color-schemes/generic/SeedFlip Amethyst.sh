...
put_template 7  "0e/05/19"
put_template 8  "b5/ab/a0"
put_template 9  "ee/2b/2b"
put_template 10 "12/d4/52"
put_template 11 "d4/b3/12"
put_template 12 "2b/7c/ee"
put_template 13 "ee/2b/ee"
put_template 14 "05/c8/c8"
put_template 15 "1a/0a/2e"

color_foreground="1a/0a/2e"
color_background="f8/f7/f6"

if [ -n "$ITERM_SESSION_ID" ]; then
  # iTerm2 proprietary escape codes
  put_template_custom Pg "1a0a2e"
  put_template_custom Ph "f8f7f6"
  put_template_custom Pi "1a0a2e"
  put_template_custom Pj "ffffff"
  put_template_custom Pk "1a0a2e"
  put_template_custom Pl "635bff"
  put_template_custom Pm "1a0a2e"
else
