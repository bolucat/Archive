...
put_template 15 "1d/1d/1d"

color_foreground="1d/1d/1d"
color_background="ff/ff/ff"

if [ -n "$ITERM_SESSION_ID" ]; then
  # iTerm2 proprietary escape codes
  put_template_custom Pg "1d1d1d"
  put_template_custom Ph "ffffff"
  put_template_custom Pi "1d1d1d"
  put_template_custom Pj "f5f5f5"
  put_template_custom Pk "1d1d1d"
  put_template_custom Pl "f24e1e"
