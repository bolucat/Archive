...
color_foreground="b3/ff/b3"
color_background="0c/0c/0c"

if [ -n "$ITERM_SESSION_ID" ]; then
  # iTerm2 proprietary escape codes
  put_template_custom Pg "b3ffb3"
  put_template_custom Ph "0c0c0c"
  put_template_custom Pi "b3ffb3"
  put_template_custom Pj "141414"
  put_template_custom Pk "b3ffb3"
  put_template_custom Pl "00ff88"
  put_template_custom Pm "0c0c0c"
else
