...
#pragma redefine_extname SSL_get_negotiated_client_cert_type BORINGSSL_ADD_USER_LABEL_AND_PREFIX(SSL_get_negotiated_client_cert_type)
...
#define SSL_get_negotiated_client_cert_type BORINGSSL_ADD_PREFIX(SSL_get_negotiated_client_cert_type)
