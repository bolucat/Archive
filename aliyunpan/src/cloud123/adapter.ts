...
export const listCloud123Items = async (userId: string, driveId: string, dirId: string, includeFiles: boolean) => {
  ...
  const items = (await apiCloud123FileList(userId, parentFileId, 100, isTrash, searchData)).map(item => {
