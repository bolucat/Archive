...
export const listOneDriveItems = async (userId: string, driveId: string, dirId: string, includeFiles: boolean, nextLink = '', strict = false) => {
  ...
  const page = await apiOneDriveFileListPage(userId, parentId, nextLink, strict, 200)
