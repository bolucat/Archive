...
replace github.com/v2fly/v2ray-core/v5 => github.com/sagernet/v2ray-core/v5 v5.0.17-0.20220706020346-c2f8382035ea
...
require (
	...
	github.com/sagernet/sing v0.0.0-20220705090238-53c9f8d1374f // indirect
