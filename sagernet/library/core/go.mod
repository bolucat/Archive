...
replace github.com/v2fly/v2ray-core/v5 => github.com/sagernet/v2ray-core/v5 v5.0.11-0.20220524000938-071a6ca0aa81
...
require (
	...
	github.com/sagernet/sing v0.0.0-20220523120129-8697b84d5946 // indirect
