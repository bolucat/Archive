	...
	app.Commands = []*cli.Command{
		...
		&cli.Command{
			...
			Action: func(c *cli.Context) error {
				...
				s, err := brook.NewWSClientWithServerAddress(a, h, c.String("wsserver"), c.String("password"), c.Int("tcpTimeout"), c.Int("udpTimeout"), c.String("serverAddress"))
				if err != nil {
					return err
				}
				http, err := brook.NewSocks5ToHTTP(c.String("http"), c.String("socks5"), "", "", c.Int("tcpTimeout"))
		...
		&cli.Command{
			...
			Action: func(c *cli.Context) error {
				...
				s, err := brook.NewWSClientWithServerAddress(a, h, c.String("wssserver"), c.String("password"), c.Int("tcpTimeout"), c.Int("udpTimeout"), c.String("serverAddress"))
				if err != nil {
					return err
				}
				http, err := brook.NewSocks5ToHTTP(c.String("http"), c.String("socks5"), "", "", c.Int("tcpTimeout"))
