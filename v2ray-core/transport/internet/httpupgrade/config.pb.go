...
const file_transport_internet_httpupgrade_config_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value\"\xb3\x02\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x06header\x18\x05 \x03(\v29.v2ray.core.transport.internet.request.httpupgrade.HeaderR\x06header\x121\n" +
	"\x15parse_x_forwarded_for\x18\x06 \x01(\bR\x12parseXForwardedFor: \x82\xb5\x18\x1c\n" +
